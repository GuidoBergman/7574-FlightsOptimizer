...
class ResultadoEstadisticaPrecios:
    ...
    def convertir_a_str(self):
        string = f'Tipo resultado: Estadisticas precios   Trayecto: {self.trayecto}  Precio promedio: {int(round(self.precio_promedio, 0))} Precio máximo: {int(round(self.precio_maximo, 0))}'
        return string

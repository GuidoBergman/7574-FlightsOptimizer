...
def main():
    ...
    datosarchivos.append(DatosArchivo("archivo_prueba5.csv", 72, 0, 234, 0))
    datosarchivos.append(DatosArchivo("archivo_prueba6.csv", 84, 4509, 234, 540))
    datosarchivos.append(DatosArchivo("archivo_prueba7.csv", 85, 4592, 234, 566))
    datosarchivos.append(DatosArchivo("archivo_prueba8.csv", 83, 0, 234, 561))
    datosarchivos.append(DatosArchivo("archivo_prueba9.csv", 88, 4619, 234, 552))

...
class SesionCliente:
    def __init__(self, _client_sock, cant_filtros_escalas,
        ...
        self._protocolos.append(ProtocoloFiltroPrecio(cant_filtros_precio, self.id_cliente))
        
        # El protocolo distancia lo arreglo en los dos vectores de protocolos
        protDistancia = ProtocoloFiltroDistancia(cant_filtros_distancia, self.id_cliente)
